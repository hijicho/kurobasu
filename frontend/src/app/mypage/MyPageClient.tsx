...
export default function MyPageClient() {
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-16">
          <div className="max-w-md w-full text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-8 py-3 btn-theme-primary rounded-xl"
            >
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Header isAuthenticated={isAuthenticated} onGlossaryOpen={() => setGlossaryOpen(true)} />
        ...
        <div className="max-w-[1440px] mx-auto">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className={`px-4 py-2 rounded-lg ${
                  activeTab === 'favorites' ? 'btn-theme-primary' : 'bg-gray-200 text-gray-600'
                }`}
              >
                お気に入り
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-lg ${
                  activeTab === 'mytimetable' ? 'btn-theme-primary' : 'bg-gray-200 text-gray-600'
                }`}
              >
                マイ時間割（確定済み）
              </button>
          ...
          {activeTab === 'favorites' && (
            <div className="mb-8">
              {hasFavorites ? (
                <>
                  <div className="mb-4 bg-theme-primary-light border border-[#2B4DCA] rounded-xl p-4">
                    ...
                    {favoriteCourses.map((course) => (
                      ...
                      >
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1 cursor-pointer" onClick={() => router.push(`/course/${course.id}`)}>
                ...
                <>
                  ...
                  <div className="mt-6 flex justify-center">
                    <button
                      ...
                      className="flex items-center gap-2 px-8 py-3 btn-theme-primary rounded-xl shadow-lg text-base"
                    >
