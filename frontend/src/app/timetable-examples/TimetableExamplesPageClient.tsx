...
export default function TimetableExamplesPageClient() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 max-w-[1440px] mx-auto w-full px-6 py-8">
        ...
        {/* 注意事項 */}
        <div className="mt-8 bg-theme-primary-light border border-[#2B4DCA] rounded-xl p-6">
