...
interface AgricultureNoDataPageProps {
  isAuthenticated?: boolean;
}

export function AgricultureNoDataPage({ isAuthenticated = false }: AgricultureNoDataPageProps) {
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 max-w-[1440px] mx-auto w-full px-4 md:px-6 py-6 md:py-8">
        ...
        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl md:text-3xl mb-2">農学部</h1>
        </div>
