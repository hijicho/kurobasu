...
interface LifeScienceCoursesListPageProps {
  isAuthenticated?: boolean;
  onCourseClick?: (courseId: string) => void;
}

export function LifeScienceCoursesListPage({ isAuthenticated = false, onCourseClick }: LifeScienceCoursesListPageProps) {
  const [searchQuery, setSearchQuery] = useState('');

  // 生活科学部の科目データ
  const courses = [
    { id: 'basic-cell-biology-kim', name: '基礎細胞生物学', instructor: '金東浩' },
    { id: 'social-policy-kakita', name: '社会政策学', instructor: '垣田裕介' },
    { id: 'welfare-system1-onishi', name: '福祉システム学1', instructor: '大西次郎' },
    { id: 'clinical-psychology-intro-ogata', name: '臨床心理学概論', instructor: '緒方康介' },
    { id: 'social-welfare-principles-tokoro', name: '社会福祉原理論', instructor: '所道彦' },
  ];
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 max-w-[1440px] mx-auto w-full px-4 md:px-6 py-6 md:py-8">
        ...
        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl md:text-3xl mb-2">生活科学部科目一覧</h1>
