...
export function MedicalRehabCoursesListPage({ isAuthenticated = false, onCourseClick }: MedicalRehabCoursesListPageProps) {
  ...
  const courses = [
    { id: 'morphology-function-1-miyai', name: '形態機能学1', instructor: '宮井' },
    { id: 'morphology-function-practice-1-miyai', name: '形態機能学実習1', instructor: '宮井' },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 max-w-[1440px] mx-auto w-full px-4 md:px-6 py-6 md:py-8">
        <Breadcrumb items={[
          { label: 'トップ', href: '/' },
          { label: '医学部リハビリテーション学科科目一覧' },
        ]} />

        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl md:text-3xl mb-2">医学部リハビリテーション学科科目一覧</h1>
          <p className="text-sm md:text-base text-gray-600">専門科目のレビューを見ることができます</p>
        </div>

        {/* 検索欄（医学部リハビリテーション学科専用機能） */}
        <div className="mb-6 md:mb-8">
